...
function initPostFx() 
    ...
    if SKYGFX.bloom then initBloom() end
end
...
function renderPostFX() 
    ...
    if SKYGFX.doRadiosity == true then
        ...
        local radiosityIntensity = SKYGFX.radiosityIntensity == 0 and TIMECYC:getTimeCycleValue("radiosity") or SKYGFX.radiosityIntensity
