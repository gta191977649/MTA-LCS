...
T = {
    ...
    waterR = 43, waterG = 44, waterB = 45, waterA = 46,
}
...
function interpolate(a,b,fa,fb,isCurrent)
    ...
    if not isCurrent then -- interpolate direct from timecyc data
        ...
        weather.water = interpolateRGBA({a[T["waterR"]],a[T["waterG"]],a[T["waterB"]],255}, {b[T["waterR"]],b[T["waterG"]],b[T["waterB"]],255}, fa, fb)
